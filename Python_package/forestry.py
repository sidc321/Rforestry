...
def sample_weights_checker(featureWeights, mtry, ncol):
    ...
    featureWeightsVariables = [i for i in featureWeights if featureWeights[i] > max(featureWeights)*0.001]
...
class forestry:
    ...
    def __init__(
        ...
        #HANDLE THE DEFAULT VALUES THAT DEPEND ON OTHER PARAMETERS
