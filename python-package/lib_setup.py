...
def setup_lib(lib):
    ...
    lib.get_children_left.argtypes = [ctypes.c_void_p]
    lib.get_children_left.restype = ctypes.c_void_p

    lib.get_children_right.argtypes = [ctypes.c_void_p]
    ...
    lib.get_num_samples.argtypes = [ctypes.c_void_p]
    lib.get_num_samples.restype = ctypes.c_void_p

    lib.get_threshold.argtypes = [ctypes.c_void_p]
    lib.get_threshold.restype = ctypes.c_void_p

    lib.get_values.argtypes = [ctypes.c_void_p]
