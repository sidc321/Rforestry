...
rcpp_cppDataFrameInterface <- function(x, y, catCols, linCols, numRows, numColumns, featureWeights, featureWeightsVariables, deepFeatureWeights, deepFeatureWeightsVariables, observationWeights, customSplittingSample, customAveragingSample, customExcludedSample, monotonicConstraints, groupMemberships, monotoneAvg) {
    .Call(`_Rforestry_rcpp_cppDataFrameInterface`, x, y, catCols, linCols, numRows, numColumns, featureWeights, featureWeightsVariables, deepFeatureWeights, deepFeatureWeightsVariables, observationWeights, customSplittingSample, customAveragingSample, customExcludedSample, monotonicConstraints, groupMemberships, monotoneAvg)
}
