...
rcpp_cppDataFrameInterface <- function(x, y, catCols, linCols, numRows, numColumns, featureWeights, featureWeightsVariables, deepFeatureWeights, deepFeatureWeightsVariables, observationWeights, customSplittingSet, customAveragingSet, customExcludedSet, monotonicConstraints, groupMemberships, monotoneAvg) {
    .Call(`_Rforestry_rcpp_cppDataFrameInterface`, x, y, catCols, linCols, numRows, numColumns, featureWeights, featureWeightsVariables, deepFeatureWeights, deepFeatureWeightsVariables, observationWeights, customSplittingSet, customAveragingSet, customExcludedSet, monotonicConstraints, groupMemberships, monotoneAvg)
}
